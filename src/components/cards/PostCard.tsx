...
export default function PostCard({
  ...
  const initialUser = { ...(post.usuario as User) };
  if (post.usuario.foto === null) initialUser.foto = "";
          ...
          <Link to={`/users/${post.usuario.id}`} className="flex items-center">
            <img
              ...
              src={
                initialUser.foto != ""
                  ? initialUser.foto
                  : `https://api.dicebear.com/7.x/bottts-neutral/svg?seed=${initialUser.usuario
                      .split("@")
                      .shift()}`
              }
              alt="avatar"
