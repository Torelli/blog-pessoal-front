    ...
    <article className="bg-white border border-gray-300 border-l-8 border-l-blue-500 rounded-lg shadow">
      ...
      >
        <img
          ...
          src={`https://api.dicebear.com/7.x/icons/svg?seed=${title}&radius=50&backgroundType=gradientLinear&backgroundColor=c026d3,3b82f6`}
          alt="avatar"
        />
        <h3 className="font-bold transition-all">{title}</h3>
      </button>
    </article>
  );
}
